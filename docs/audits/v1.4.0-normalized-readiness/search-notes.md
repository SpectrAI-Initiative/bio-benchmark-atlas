...
| MoleculeNet auxiliary learning | [Journal of Cheminformatics article](https://doi.org/10.1186/s13321-024-00880-7), PMCID `PMC11270959` | [GraphTA repository at `0eef8c9`](https://github.com/vishaldeyiiest/GraphTA/tree/0eef8c948bce040e27f01dc18f9fdbbbad8468a6), [GraphTA Zenodo v0.1.0](https://doi.org/10.5281/zenodo.11894598), [upstream checkpoint repository](https://github.com/snap-stanford/pretrain-gnns/tree/8b20528a83b8869ce16451305b32c827258d19a3), and [MoleculeNet creator paper](https://doi.org/10.1039/C7SC02664A) | Table 1 reports eight named datasets, scaffold splitting, ten seeds, and ROC-AUC mean/standard deviation. The GraphTA archive pins the evaluation code, and current upstream checkpoint files have stable Git blobs, but the paper and archive do not record the dataset-archive digest or checkpoint blob IDs used for those runs. The current downloadable bytes cannot be promoted to the evaluated snapshot. |
...
The MoleculeNet auxiliary-learning Table 1 recommendation was completed as a
stop audit in Issue #367. GraphTA `v0.1.0`, commit `0eef8c9`, the upstream
checkpoint repository at `8b20528`, and all eight linked dataset members were
inspected. A deterministic scaffold inventory was reproduced locally only as a
consistency check; it was not published as paper-reported `n`, because the
modern RDKit version and current archive are not identified by the article as
the exact evaluated environment. No model evaluation was run and no Registry
record was upgraded.
